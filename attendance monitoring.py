...
#creating the list for storing all the images
path = 'photos'
images = []
classNames = []
...
#function creating a list of RGB encodings for all the pictures
...
def markAttendance(name):
    with open('2022-10-12.csv','r+') as f:
...
#initializing webcam and converting BGR to RGB images
